...
const About = () => (
  <div className="flex h-full gap-20 overflow-hidden">
    <div className="h-full w-full flex-auto">
      <Image priority alt="Александра Мельникова" className=" object-contain" src={ AboutImg } />
    </div>
    <div className="flex h-full w-full flex-col justify-between">

      <div className="flex flex-none shrink flex-col gap-4">
        <h1 className="font-default text-md text-black+">
      ...
      <div className="flex flex-col gap-8">
        <h1 className="font-default text-md text-black+">Почему фотографии?</h1>
        <div className="flex flex-col">
          <p className="text-md font-light text-black+">Честно, она помогла мне реализовать три потребности:</p>
          <ul className="flex flex-col text-md font-light text-black+">
            { listItems.map((item) => (
        ...
        <p className="text-md font-light text-black+">Здесь я чувствую себя на своём месте. Именно поэтому меня ценят клиенты, и мы вместе достигаем крутых результатов.</p>
      </div>
